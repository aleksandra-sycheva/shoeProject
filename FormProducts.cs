...
namespace shoeProject
{
    public partial class FormProducts : Form
    {
        ...
        private string FormatProductInfo(Product product)
        {
            ...
            return $"{product.Category.CategoryName} | {product.Type.ProdType}" + Environment.NewLine +
                ...
                $"Постовщик:{product.Supplier.SupplierName}" + Environment.NewLine +
                $"Цена: {priceText}" + Environment.NewLine +
                $"Единица ихмерения: {product.Measure.MeasureName} " + Environment.NewLine +
